...
Your name(s): Tavishi Sharma
Your team alias: NOONEWANTSTOWORKWITHME
*/
...
int main() {
    ...
    // Creating a hash table with k slots
    HashTable table(k);

    // Inserting all tokens into the hash table
    for (int i = 0; i < n; ++i) {
    ...
    table.printFirstSlots(5);

    cout << "==== Printing the slot lengths ====" << endl;
    table.printSlotLengths();

    cout << "==== Printing the standard variance =====" << endl;
    cout << fixed << setprecision(4) << table.calculateStandardDeviation() << endl;
